                    ...
                    <div class="row">
                        <asp:Panel runat="server" ID="adminDashboardPanel" Style="padding-left: 15px;">
                            <div id="adminDashboard1">
                                <div class='tableauPlaceholder' id='viz1576004735505' style='width: 1000px'>
                                    <noscript>
                                        <a href='#'>
                                            <img alt=' ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Ta&#47;Tableau484-1&#47;Dashboard1&#47;1_rss.png' style='border: none' /></a>
                                    </noscript>
                                    <object class='tableauViz' style='display: none;'>
                                        <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
                                        <param name='embed_code_version' value='3' />
                                        <param name='site_root' value='' />
                                        <param name='name' value='Tableau484-1&#47;Dashboard1' />
                                        <param name='tabs' value='no' />
                                        <param name='toolbar' value='yes' />
                                        <param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Ta&#47;Tableau484-1&#47;Dashboard1&#47;1.png' />
                                    ...
                                    <div class="atbdb_content_module_contents">
                                        <div class="user_info_wrap">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="user" class="form-label">Unverifed User</label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <label for="user" class="form-label">Block User</label>
                                                        <div class="input-group">
                                                            <asp:DropDownList ID="UserDropDown" runat="server" CssClass="custom-select"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 p-top-30">
                                                    <asp:Button ID="Deactive" runat="server" CssClass="btn btn-sm btn-secondary form-control-file" Text="Deactive" OnClick="Deactive_Click" />
                                                </div>

                                                <div class="col-md-6 form-group">
                                                    <div class="input-group">
                                                        <label for="user" class="form-label">Active User</label>
                                                        <div class="input-group">
                                                            <asp:DropDownList ID="DeavtivedUserDropDownList" runat="server" CssClass="custom-select"></asp:DropDownList>                                                       
                                                        </div>
                                                         <asp:Label ID="DeactivedLbl" runat="server" Text="No Blocked User!" Visible="false" Font-Italic="true" ForeColor="ForestGreen"></asp:Label>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 p-top-30">
                                                    <asp:Button ID="Active" runat="server" CssClass="btn btn-sm btn-secondary form-control-file" Text="Active" OnClick="Active_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
