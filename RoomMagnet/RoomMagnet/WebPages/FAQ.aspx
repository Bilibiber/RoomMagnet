...
Why is there a need for RoomMagnet?
...
What is RoomMagnet’s HomeshareSmarter® Living option?
...
Who are RoomMagnet’s Advisors?
Our advisors are available to assist hosts who would rather sit back and experience the benefits of the RoomMagnet program but not the hassle of getting set up. E-mail us today and let us set up a personal meeting with one of our advisors to walk you through the process. It’s that easy!

What is RoomMagnet’s background screening procedure?
...
What is the cost of my criminal background check?
...
What is the cost of becoming part of the RoomMagnet community?
...
Why do we use Stripe to disperse payments?
...
How can I get involved with RoomMagnet?
...
FAQ’s for a description of the background screening procedure). All background screenings are
performed according to FCRA regulations.
We require that both Hosts and Tenants initiate a background screening and
encourage both who are contemplating a living arrangement to share this information.
This will give other users that extra comfort in knowing a little more about those whom they’re
considering sharing a home.
Please keep in mind that once a connection is made users may agree to share personal
background information. However it is only for their use only, and not to be shared with any
third party.
We know that nothing in life is 100% perfect. The comprehensive background screening is
performed by an experienced third party with the results provided to RoomMagnet. The results
are based solely on the information available in their normal screening process.
To initiate a personal background screen click the link below and when prompted enter the
