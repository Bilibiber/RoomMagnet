...
<body>
    <section class="header-breadcrumb bgimage overlay overlay--dark">
        <div class="bg_image_holder"><img src="img/rm/home-1.jpg" alt="home"></div>
                            ...
                            <div class="atbdb_content_module_contents">
                                ...
                                <!-- replace latin text with your answers -->
                                    ...
                                    <div class="accordion-single selected">
                                        ...
                                        <p class="ac-body" style="display: block;">RoomMagnet provides an easy to use platform where pre-screened Tenants and Hosts come together, and in exchange for a 
                                            ...
                                            little help around the house. Tenants enjoy affordable housing.</p>
                                    </div>
                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">Who can use RoomMagnet?</a></h3>
                                        <p class="ac-body" style="display: none;">Roommagnet users must be at least 18 years of age and are seeking a minimum of 30 days stay in Host lodging. 
                                            ...
                                            graduate students, international students, doctoral and nursing interns as well as college students seeking affordable off campus housing.</p>
                                    </div>
                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">Who are host families?</a></h3>
                                        <p class="ac-body" style="display: none;">Host families are those who have room in their home, empty-nesters and people of advanced age who wish to age in place, 
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <p class="ac-body" style="display: none;">Roommagnet connects host families who wish to share empty space in their home with responsible inter-generational adults who seek 
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <p class="ac-body" style="display: none;">As the cost of housing increases and become more scare in highly populated areas, it becomes harder for responsible students, as well as 
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <p class="ac-body" style="display: none;">Tenants who are open to assisting host families with some basic chores like running errands, doing yard work or just providing companionship or
                                            personal assistance will receive a discount on their housing. We call this HomeShareSmarter® Living.</p>
                                    </div>

                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">Who are RoomMagnet's advisors?</a></h3>
                                        <p class="ac-body" style="display: none;">Our advisors are available to assist hosts who would rather sit back and experience the benefits of the RoomMagnet program but not the hassle of 
                                            getting set up. E-mail us today and let us set up a personal meeting with one of our advisors to walk you through the process. It’s that easy!</p>
                                    </div>

                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">What is RoomMagnet's background screening process?</a></h3>
                                        <p class="ac-body" style="display: none;">We require all RoomMagnet users ( Tenants and Hosts) who wish to connect on our platform  to initiate a background check. 
                                            ...
                                            either party may continue to search the site to find a compatible match, however before a match is consummated a background screen must be initiated.</p>
                                    </div>

                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">What is the cost of my criminal background check?</a></h3>
                                        <p class="ac-body" style="display: none;">RoomMagnet has selected a criminal background company that follows the Federal Credit Reporting Act (FCRA) regulations.
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <p class="ac-body" style="display: none;">RoomMagnet does not charge either Tenants or Hosts a fee to register, develop a profile, list a property or search.
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <p class="ac-body" style="display: none;">Stripe is a recognized secure payment platform that works similar to Paypal in that it collects payments from RoomMagnet Renters
                                            ...
                                            Stripe is a network with redundant security encryption, and all information is kept strictly confidential. For more information on stripe visit www.stripe.com.</p>
                                    </div>

                                    <div class="accordion-single">
                                        <h3 class="faq-title"><a href="#">How can I get involved with RoomMagnet?</a></h3>
                                        <p class="ac-body" style="display: none;">We are currently looking for people with strong writing skills to use their talents to write articles to be featured on
