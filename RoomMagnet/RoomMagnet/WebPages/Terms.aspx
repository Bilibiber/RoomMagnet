    ...
    <body>
        <section class="header-breadcrumb bgimage overlay overlay--dark">
            <div class="bg_image_holder">
                <img src="img/rm/home-5.jpg" alt="home"></div>
...
<%--                        <h3>Example Drug Free Statement</h3>--%>
                   ...
                   <%-- <div class="col-lg-12 privacy title">
                        <p>
                            In consideration of the execution or renewal of a lease of the dwelling unit identified in the Rental/Lease Agreement, 
                          ...
                          persons under the Tenant 's control will not permit the dwelling unit to be used for, or to facilitate , criminal activity, including drug-related criminal activity, 
                          ...
                          Host and Tenant.Date___________________________Tenant____________________Date___________________________Host______________________
                        </p>
                        <p></p>
                    ...
                    <div class="col-lg-12 privacy title">
                        <p>
                            The Fair HousingAct (Title VIII of the Civil Rights Act of 1968), prohibits discrimination in the rental of housing based on race, color, national origin, religion,handicap (disability),sex,
                    ...
                    RoomMagnet users to comply, in all respects, with all laws, rules, and regulations regarding landlord and tenant, including the requirements imposed by the Fair Housing Act.
                        </p>
                    </div>--%>
                ...
                <div class="col-lg-12">
                    <h3>POTENTIAL TERMS OF SERVICE/PRIVACY NOTES TO ADD FROM BOB/JOE</h3>
                    <ul>
